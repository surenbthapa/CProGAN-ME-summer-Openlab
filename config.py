...
data_dir ='/root/UNOSAT/rundir/tfrecords256'
result_dir ='/root/UNOSAT/rundir/results256'
...
desc += '-preset-v2-4gpus'; num_gpus = 4; sched.minibatch_base = 16; sched.minibatch_dict = {4: 512, 8: 256, 16: 128, 32: 64, 64: 32, 128: 16}; sched.G_lrate_dict = {256: 0.0015, 512: 0.002, 1024: 0.003}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); sched.lod_training_kimg = 300; sched.lod_transition_kimg = 1500; train.total_kimg = 6000
...
#desc += '-VERBOSE'; sched.tick_kimg_base = 1; sched.tick_kimg_dict = {}; train.image_snapshot_ticks = 10; train.network_snapshot_ticks = 140;  train.resume_run_id = None; train.resume_kimg = 6163
